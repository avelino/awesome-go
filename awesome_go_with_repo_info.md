...
-   [mow.cli](https://github.com/jawher/mow.cli) <span> ★ 342, pushed 61 days ago </span> - A Go library for building CLI applications with sophisticated flag and argument parsing and validation.
...
-   [store](https://github.com/tucnak/store) <span> ★ 38, pushed 104 days ago </span> - A lightweight configuration manager for Go
...
-   [ttlcache](https://github.com/diegobernardes/ttlcache) <span> ★ 22, pushed 15 days ago </span> - An in-memory LRU string-interface{} map with expiration for golang
...
-   [pgweb](https://github.com/sosedoff/pgweb) <span> ★ 3372, pushed 7 days ago </span> - A web-based PostgreSQL database browser
...
-   NoSQL Databases
    ...
    -   [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) <span> ★ 168, pushed 20 days ago </span> - Aerospike client in Go language.
...
-   [go-persian-calendar](https://github.com/yaa110/go-persian-calendar) <span> ★ 5, pushed 50 days ago </span> - The implementation of the Persian (Solar Hijri) Calendar in Go (golang).
...
-   [imaging](https://github.com/disintegration/imaging) <span> ★ 790, pushed 54 days ago </span> - Simple Go image processing package.
...
-   [slog](https://github.com/ventu-io/slog) <span> ★ 16, pushed 27 days ago </span> - The reference implementation of the Structured Logging Facade (SLF) for Go
...
-   [go-shortid](https://github.com/ventu-io/go-shortid) <span> ★ 51, pushed 64 days ago </span> - Distributed generation of super short, unique, non-sequential, URL friendly IDs.
...
-   [sentences](https://github.com/neurosnap/sentences) <span> ★ 124, pushed 7 days ago </span> - A sentence tokenizer: converts text into a list of sentences.
...
-   [portproxy](https://github.com/aybabtme/portproxy) <span> ★ 21, pushed 496 days ago </span> - Simple TCP proxy which adds CORS support to API's which don't support it.
...
-   Testing Frameworks
    ...
    -   [godog](https://github.com/DATA-DOG/godog) <span> ★ 55, pushed 22 days ago </span> - Cucumber or Behat like BDD framework for Go.
...
-   Specific Formats
    ...
    -   [go-pkg-rss](https://github.com/jteeuwen/go-pkg-rss) <span> ★ 266, pushed 16 days ago </span> - This package reads RSS and Atom feeds and provides a caching mechanism that adheres to the feed specs.
...
-   [steam](https://github.com/sostronk/go-steam) <span> ★ 7, pushed 345 days ago </span> - Go Library to interact with Steam game servers.
...
-   [TheMovieDb](https://github.com/jbrodriguez/go-tmdb) <span> ★ 4, pushed 171 days ago </span> - A simple golang package to communicate with [themoviedb.org](https://themoviedb.org)
-   [translate](https://github.com/poorny/translate) - Go online translation package.
-   [tumblr](https://github.com/mattcunningham/gumblr) <span> ★ 0, pushed 284 days ago </span> - Go wrapper for the Tumblr v2 API.
-   [webhooks](https://github.com/go-playground/webhooks) <span> ★ 14, pushed 64 days ago </span> - Webhook reciever for GitHub and Bitbucket.
...
-   [abutil](https://github.com/bahlo/abutil) <span> ★ 5, pushed 233 days ago </span> - A collection of often-used Golang helpers.
-   [apm](https://github.com/topfreegames/apm) <span> ★ 33, pushed 43 days ago </span> - A process manager for Golang applications with an HTTP API.
-   [boilr](https://github.com/tmrts/boilr) <span> ★ 47, pushed 47 days ago </span> - A blazingly fast CLI tool for creating projects from boilerplate templates.
-   [command](https://github.com/txgruppi/command) <span> ★ 1, pushed 2 days ago </span> - Command pattern for Go with thread safe serial and parallel dispatcher
-   [coop](https://github.com/rakyll/coop) <span> ★ 1142, pushed 199 days ago </span> - Cheat sheet for some of the common concurrent flows in Go.
-   [Death](https://github.com/vrecan/death) <span> ★ 24, pushed 48 days ago </span> - Managing go application shutdown with signals.
-   [Deepcopier](https://github.com/ulule/deepcopier) <span> ★ 81, pushed 4 days ago </span> - Simple struct copying for Go.
-   [delve](https://github.com/derekparker/delve) <span> ★ 3544, pushed 0 days ago </span> - Go debugger.
-   [fastlz](https://github.com/digitalcrab/fastlz) <span> ★ 4, pushed 437 days ago </span> - Wrap over [FastLz](http://fastlz.org/) (free, open-source, portable real-time compression library) for GoLang.
-   [filetype](https://github.com/h2non/filetype) <span> ★ 55, pushed 122 days ago </span> - Small package to infer the file type checking the magic numbers signature.
-   [fzf](https://github.com/junegunn/fzf) <span> ★ 4703, pushed 0 days ago </span> - A command-line fuzzy finder written in Go
-   [generate](https://github.com/go-playground/generate) <span> ★ 1, pushed 100 days ago </span> - runs go generate recursively on a specified path or environment variable and can filter by regex.
-   [gentleman](https://github.com/h2non/gentleman) <span> ★ 263, pushed 1 days ago </span> - Full-featured plugin-driven HTTP client library.
...
-   [go-debug](https://github.com/tj/go-debug) <span> ★ 313, pushed 113 days ago </span> - Conditional debug logging for Golang libraries & applications.
-   [go-dry](https://github.com/ungerik/go-dry) <span> ★ 145, pushed 11 days ago </span> - DRY (don't repeat yourself) package for Go.
-   [go-rate](https://github.com/beefsack/go-rate) <span> ★ 187, pushed 605 days ago </span> - A timed rate limiter for Go.
-   [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) <span> ★ 11, pushed 8 days ago </span> - XML Sitemap generator written in Go.
-   [go-trigger](https://github.com/sadlil/go-trigger) <span> ★ 43, pushed 51 days ago </span> - Go-lang global event triggerer, Register Events with an id and trigger the event from anywhere from your project.
-   [go-underscore](https://github.com/tobyhede/go-underscore) <span> ★ 839, pushed 298 days ago </span> - A useful collection of helpfully functional Go collection utilities.
-   [goback](https://github.com/carlescere/goback) <span> ★ 24, pushed 405 days ago </span> - Go simple exponential backoff package.
-   [godaemon](https://github.com/VividCortex/godaemon) <span> ★ 250, pushed 225 days ago </span> - Utility to write daemons.
-   [godotenv](https://github.com/joho/godotenv) <span> ★ 282, pushed 61 days ago </span> - A Go port of Ruby's dotenv library (Loads environment variables from `    .env   ` .)
-   [godropbox](https://github.com/dropbox/godropbox) <span> ★ 3028, pushed 57 days ago </span> - Common libraries for writing Go services/applications from Dropbox.
-   [gohper](https://github.com/cosiner/gohper) <span> ★ 211, pushed 1 days ago </span> - Various tools/modules help for development.
-   [gojq](https://github.com/elgs/gojq) <span> ★ 33, pushed 1 days ago </span> - JSON query in Golang.
-   [golarm](https://github.com/msempere/golarm) <span> ★ 16, pushed 242 days ago </span> - Fire alarms with system events.
-   [golog](https://github.com/mlimaloureiro/golog) <span> ★ 15, pushed 80 days ago </span> - Easy and lightweight CLI tool to time track your tasks.
-   [gopencils](https://github.com/bndr/gopencils) <span> ★ 342, pushed 92 days ago </span> - Small and simple package to easily consume REST APIs.
-   [goplaceholder](https://github.com/michiwend/goplaceholder) <span> ★ 10, pushed 96 days ago </span> - a small golang lib to generate placeholder images.
-   [goreq](https://github.com/franela/goreq) <span> ★ 448, pushed 29 days ago </span> - Minimal and simple request library for Go language.
-   [goreq](https://github.com/smallnest/goreq) <span> ★ 14, pushed 65 days ago </span> - An enhanced simplified HTTP client based on gorequest.
-   [gorequest](https://github.com/parnurzeal/gorequest) <span> ★ 666, pushed 41 days ago </span> - Simplified HTTP client with rich features for Go.
-   [gotenv](https://github.com/subosito/gotenv) <span> ★ 49, pushed 565 days ago </span> - Load environment variables from `    .env   ` or any `    io.Reader   ` in Go
-   [grequests](https://github.com/levigross/grequests) <span> ★ 709, pushed 12 days ago </span> - An elegant and simple `    net/http   ` wrapper that follows Python's requests library
-   [htcat](https://github.com/htcat/htcat) <span> ★ 420, pushed 319 days ago </span> - Parallel and Pipelined HTTP GET Utility
-   [httpcontrol](https://github.com/facebookgo/httpcontrol) <span> ★ 405, pushed 279 days ago </span> - Package httpcontrol allows for HTTP transport level control around timeouts and retries.
-   [hystrix-go](https://github.com/afex/hystrix-go) <span> ★ 384, pushed 54 days ago </span> - Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker.
-   [JobRunner](https://github.com/bamzi/jobrunner) <span> ★ 265, pushed 175 days ago </span> - Smart and featureful cron job scheduler with job queuing and live monitoring built in.
-   [jsonf](https://github.com/miolini/jsonf) <span> ★ 25, pushed 333 days ago </span> - Console tool for highlighted formatting and struct query fetching JSON.
-   [jsongo](https://github.com/ricardolonga/jsongo) <span> ★ 48, pushed 223 days ago </span> - Fluent API to make it easier to create Json objects.
-   [lrserver](https://github.com/jaschaephraim/lrserver) <span> ★ 67, pushed 203 days ago </span> - LiveReload server for Go
...
-   [mergo](https://github.com/imdario/mergo) <span> ★ 124, pushed 44 days ago </span> - A helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
-   [moldova](https://github.com/StabbyCutyou/moldova) <span> ★ 116, pushed 6 days ago </span> - A utility for generating random data based on an input template.
-   [mp](https://github.com/sanbornm/mp) <span> ★ 11, pushed 676 days ago </span> - A simple cli email parser. It currently takes stdin and outputs JSON.
-   [multitick](https://github.com/VividCortex/multitick) <span> ★ 44, pushed 704 days ago </span> - Multiplexor for aligned tickers.
-   [netbug](https://github.com/e-dard/netbug) <span> ★ 30, pushed 176 days ago </span> - Easy remote profiling of your services.
-   [ngrok](https://github.com/inconshreveable/ngrok) <span> ★ 6926, pushed 13 days ago </span> - Introspected tunnels to localhost.
-   [okrun](https://github.com/xta/okrun) <span> ★ 11, pushed 564 days ago </span> - go run error steamroller.
-   [panicparse](https://github.com/maruel/panicparse) <span> ★ 1258, pushed 36 days ago </span> - Groups similar goroutines and colorizes stack dump.
-   [peco](https://github.com/peco/peco) <span> ★ 2939, pushed 30 days ago </span> - Simplistic interactive filtering tool.
...
-   [pm](https://github.com/VividCortex/pm) <span> ★ 39, pushed 588 days ago </span> - Process (i.e. goroutine) manager with an HTTP API.
-   [profile](https://github.com/davecheney/profile) <span> ★ 420, pushed 94 days ago </span> - Simple profiling support package for Go.
-   [request](https://github.com/mozillazg/request) <span> ★ 120, pushed 58 days ago </span> - Go HTTP Requests for Humans™.
-   [rerun](https://github.com/ivpusic/rerun) <span> ★ 102, pushed 79 days ago </span> - Recompiling and rerunning go apps when source changes.
-   [resty](https://github.com/go-resty/resty) <span> ★ 281, pushed 78 days ago </span> - Simple HTTP and REST client for Go inspired by Ruby rest-client.
-   [robustly](https://github.com/VividCortex/robustly) <span> ★ 103, pushed 344 days ago </span> - Runs functions resiliently, catching and restarting panics.
-   [scheduler](https://github.com/carlescere/scheduler) <span> ★ 87, pushed 38 days ago </span> - Cronjobs scheduling made easy.
-   [sling](https://github.com/dghubble/sling) <span> ★ 292, pushed 12 days ago </span> - Go HTTP requests builder for API clients.
-   [spinner](https://github.com/briandowns/spinner) <span> ★ 227, pushed 54 days ago </span> - Go package to easily provide a terminal spinner with options.
-   [sqlx](https://github.com/jmoiron/sqlx) <span> ★ 1716, pushed 34 days ago </span> - provides a set of extensions on top of the excellent built-in database/sql package.
-   [ugo](https://github.com/alxrm/ugo) <span> ★ 7, pushed 31 days ago </span> - ugo is slice toolbox with concise syntax for Go.
-   [xlsx](https://github.com/tealeg/xlsx) <span> ★ 956, pushed 21 days ago </span> - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
-   [govalidator](https://github.com/asaskevich/govalidator) <span> ★ 1028, pushed 10 days ago </span> - Validators and sanitizers for strings, numerics, slices and structs.
-   [validator](https://github.com/go-playground/validator) <span> ★ 459, pushed 59 days ago </span> - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
-   [gh](https://github.com/rjeczalik/gh) <span> ★ 37, pushed 218 days ago </span> - Scriptable server and net/http middleware for GitHub Webhooks.
-   [git2go](https://github.com/libgit2/git2go) <span> ★ 785, pushed 22 days ago </span> - Go bindings for libgit2.
-   [go-vcs](https://github.com/sourcegraph/go-vcs) <span> ★ 41, pushed 67 days ago </span> - manipulate and inspect VCS repositories in Go.
-   [hgo](https://github.com/beyang/hgo) <span> ★ 7, pushed 241 days ago </span> - Hgo is a collection of Go packages providing read-access to local Mercurial repositories.
...
-   [gmf](https://github.com/3d0c/gmf) <span> ★ 185, pushed 38 days ago </span> - Go bindings for FFmpeg av\* libraries.
-   [goav](https://github.com/giorgisio/goav) <span> ★ 128, pushed 53 days ago </span> - Comphrensive Go bindings for FFmpeg.
-   [gst](https://github.com/ziutek/gst) <span> ★ 109, pushed 167 days ago </span> - Go bindings for GStreamer.
...
-   [Beego](https://github.com/astaxie/beego) <span> ★ 6867, pushed 0 days ago </span> - beego is an open-source, high-performance web framework for the Go programming language.
-   [Bone](https://github.com/go-zoo/bone) <span> ★ 894, pushed 3 days ago </span> - Lightning Fast HTTP Multiplexer.
-   [chi](https://github.com/pressly/chi) <span> ★ 295, pushed 2 days ago </span> - Small, fast and expressive HTTP router built on net/context.
-   [Echo](https://github.com/labstack/echo) <span> ★ 4154, pushed 0 days ago </span> - A fast and unfancy micro web framework for Go.
-   [Gin](https://github.com/gin-gonic/gin) <span> ★ 6342, pushed 0 days ago </span> - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
-   [Gizmo](https://github.com/NYTimes/gizmo) <span> ★ 1346, pushed 0 days ago </span> - Microservice toolkit used by the New York Times.
-   [Glue](https://github.com/desertbit/glue) <span> ★ 146, pushed 33 days ago </span> - Robust Go and Javascript Socket Library (Alternative to Socket.io).
-   [go-json-rest](https://github.com/ant0ine/go-json-rest) <span> ★ 2283, pushed 12 days ago </span> - A quick and easy way to setup a RESTful JSON API.
-   [go-kit](https://github.com/go-kit/kit) <span> ★ 3859, pushed 0 days ago </span> - A Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
-   [go-relax](https://github.com/codehack/go-relax) <span> ★ 120, pushed 27 days ago </span> - A framework of pluggable components to build RESTful API's.
-   [go-rest](https://github.com/ungerik/go-rest) <span> ★ 88, pushed 210 days ago </span> - A small and evil REST framework for Go.
-   [go-socket.io](https://github.com/googollee/go-socket.io) <span> ★ 1111, pushed 5 days ago </span> - socket.io library for golang, a realtime application framework.
...
-   [gocraft/web](https://github.com/gocraft/web) <span> ★ 1037, pushed 113 days ago </span> - A mux and middleware package in Go.
-   [Goji](https://github.com/goji/goji) <span> ★ 143, pushed 19 days ago </span> - Goji is a minimalistic and flexible HTTP request multiplexer with support for `    net/context   ` .
...
-   [golongpoll](https://github.com/jcuga/golongpoll) <span> ★ 278, pushed 71 days ago </span> - HTTP longpoll server library that makes web pub-sub simple.
-   [Gondola](https://github.com/rainycape/gondola) <span> ★ 297, pushed 139 days ago </span> - The web framework for writing faster sites, faster
-   [goose](https://github.com/ian-kent/goose) <span> ★ 20, pushed 488 days ago </span> - Server Sent Events in Go
-   [Gorilla](https://github.com/gorilla/) - Gorilla is a web toolkit for the Go programming language.
-   [httprouter](https://github.com/julienschmidt/httprouter) <span> ★ 3065, pushed 1 days ago </span> - A high performance router. Use this and the standard http handlers to form a very high performance web framework.
-   [httptreemux](https://github.com/dimfeld/httptreemux) <span> ★ 145, pushed 17 days ago </span> - High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter.
...
-   [lars](https://github.com/go-playground/lars) <span> ★ 274, pushed 9 days ago </span> - Is a lightweight, fast and extensible zero allocation HTTP router for Go used to create customizable frameworks.
-   [Macaron](https://github.com/go-macaron/macaron) <span> ★ 1077, pushed 36 days ago </span> - Macaron is a high productive and modular design web framework in Go.
-   [mango](https://github.com/paulbellamy/mango) - Mango is a modular web-application framework for Go, inspired by Rack, and PEP333.
-   [medeina](https://github.com/imdario/medeina) <span> ★ 15, pushed 461 days ago </span> - Medeina is a HTTP routing tree based on HttpRouter, inspired by Roda and Cuba.
-   [mux](https://github.com/gorilla/mux) <span> ★ 2270, pushed 21 days ago </span> - A powerful URL router and dispatcher for golang.
-   [neo](https://github.com/ivpusic/neo) <span> ★ 248, pushed 35 days ago </span> - Neo is minimal and fast Go Web Framework with extremely simple API.
-   [ozzo-routing](https://github.com/go-ozzo/ozzo-routing) <span> ★ 64, pushed 45 days ago </span> - A high-performance HTTP router and Web framework supporting routes with regular expressions. Comes with full support for quickly building a RESTful API application.
-   [pat](https://github.com/bmizerany/pat) <span> ★ 939, pushed 65 days ago </span> - Sinatra style pattern muxer for Go’s net/http library, by the author of Sinatra.
-   [Resoursea](https://github.com/resoursea/api) <span> ★ 24, pushed 446 days ago </span> - A REST framework for quickly writing resource based services.
-   [Revel](https://github.com/revel/revel) <span> ★ 6682, pushed 2 days ago </span> - A high-productivity web framework for the Go language.
-   [rex](https://github.com/goanywhere/rex) <span> ★ 10, pushed 157 days ago </span> - Rex is a library for modular development built upon gorilla/mux, fully compatible with `    net/http   ` .
-   [sawsij](http://sawsij.com/) - lightweight, open-source web framework for building high-performance, data-driven web applications.
-   [Siesta](https://github.com/VividCortex/siesta) <span> ★ 337, pushed 11 days ago </span> - Composable framework to write middleware and handlers
-   [tango](https://github.com/lunny/tango) <span> ★ 390, pushed 7 days ago </span> - Micro & pluggable web framework for Go.
-   [tigertonic](https://github.com/rcrowley/go-tigertonic) <span> ★ 929, pushed 87 days ago </span> - A Go framework for building JSON web services inspired by Dropwizard
-   [traffic](https://github.com/pilu/traffic) <span> ★ 471, pushed 148 days ago </span> - Sinatra inspired regexp/pattern mux and web framework for Go.
-   [VarHandler](https://github.com/azr/generators/tree/master/varhandler) - Generate boilerplate http input and ouput handling.
-   [vestigo](https://github.com/husobee/vestigo) <span> ★ 33, pushed 31 days ago </span> - A performant, stand-alone, HTTP compliant URL Router for go web applications.
-   [Volatile](https://github.com/volatile/core) <span> ★ 79, pushed 12 days ago </span> - Minimalist middleware stack promoting flexibility, good practices and clean code.
-   [web.go](https://github.com/hoisie/web) <span> ★ 2639, pushed 2 days ago </span> - A simple framework to write webapps in Go.
-   [xmux](https://github.com/rs/xmux) <span> ★ 48, pushed 8 days ago </span> - A high performance muxer based on `    httprouter   ` with `    net/context   ` support.
-   [Zerver](https://github.com/cosiner/zerver) <span> ★ 125, pushed 7 days ago </span> - Zerver is an expressive, modular, feature completed RESTful framework.
...
-   [CORS](https://github.com/rs/cors) <span> ★ 325, pushed 21 days ago </span> - Easily add CORS capabilities to your API.
-   [formjson](https://github.com/rs/formjson) <span> ★ 18, pushed 127 days ago </span> - Transparently handle JSON input as a standard form POST.
-   [Limiter](https://github.com/ulule/limiter) <span> ★ 214, pushed 72 days ago </span> - Dead simple rate limit middleware for Go.
-   [Tollbooth](https://github.com/didip/tollbooth) <span> ★ 367, pushed 22 days ago </span> - Rate limit HTTP request handler.
-   [XFF](https://github.com/sebest/xff) <span> ★ 45, pushed 180 days ago </span> - Handle `    X-Forwarded-For   ` header and friends.

#### Libraries for creating HTTP middlewares

-   [alice](https://github.com/justinas/alice) <span> ★ 886, pushed 19 days ago </span> - Painless middleware chaining for Go.
-   [catena](https://github.com/codemodus/catena) <span> ★ 4, pushed 187 days ago </span> - http.Handler wrapper catenation (same API as "chain").
-   [chain](https://github.com/codemodus/chain) <span> ★ 47, pushed 162 days ago </span> - Handler wrapper chaining with scoped data (net/context-based "middleware").
-   [go-wrap](https://github.com/go-on/wrap) <span> ★ 50, pushed 494 days ago </span> - Small middlewares package for net/http.
-   [gores](https://github.com/alioygur/gores) <span> ★ 39, pushed 45 days ago </span> - Go package that handles HTML, JSON, XML and etc. responses. Useful for RESTful APIs.
-   [httpware](https://github.com/nstogner/httpware) <span> ★ 13, pushed 3 days ago </span> - Stackable middleware (using net/context) with easy chaining.
-   [interpose](https://github.com/carbocation/interpose) <span> ★ 242, pushed 431 days ago </span> - Minimalist net/http middleware for golang.
-   [muxchain](https://github.com/stephens2424/muxchain) <span> ★ 198, pushed 544 days ago </span> - Lightweight middleware for net/http.
-   [negroni](https://github.com/codegangsta/negroni) <span> ★ 3574, pushed 3 days ago </span> - Idiomatic HTTP middleware for Golang.
-   [render](https://github.com/unrolled/render) <span> ★ 661, pushed 51 days ago </span> - Go package for easily rendering JSON, XML, and HTML template responses.
-   [stats](https://github.com/thoas/stats) <span> ★ 333, pushed 8 days ago </span> - A Go middleware that stores various information about your web application.
...
-   [dupl](https://github.com/mibk/dupl) <span> ★ 50, pushed 14 days ago </span> - A tool for code clone detection.
-   [errcheck](https://github.com/kisielk/errcheck) <span> ★ 555, pushed 6 days ago </span> - Errcheck is a program for checking for unchecked errors in Go programs.
-   [gcvis](https://github.com/davecheney/gcvis) <span> ★ 511, pushed 0 days ago </span> - Visualise Go program GC trace data in real time.
-   [Go Metalinter](https://github.com/alecthomas/gometalinter) <span> ★ 860, pushed 13 days ago </span> - Metalinter is a tool to automatically apply all static analysis tool and report their output in normalized form.
-   [go-checkstyle](https://github.com/qiniu/checkstyle) <span> ★ 28, pushed 636 days ago </span> checkstyle is a style check tool like java checkstyle. This tool inspired by java checkstyle, golint. The style refered to some points in Go Code Review Comments.
-   [go-outdated](https://github.com/firstrow/go-outdated) <span> ★ 21, pushed 28 days ago </span> - Console application that displays outdated packages.
-   [goast-viewer](https://github.com/yuroyoro/goast-viewer) <span> ★ 139, pushed 654 days ago </span> - Web based Golang AST visualizer.
-   [GoCover.io](http://gocover.io/) - GoCover.io offers the code coverage of any golang package as a service.
-   [goimports](https://godoc.org/golang.org/x/tools/cmd/goimports) - Tool to fix (add, remove) your Go imports automatically.
-   [GoLint](https://github.com/golang/lint) <span> ★ 1314, pushed 6 days ago </span> - Golint is a linter for Go source code.
...
-   [interfacer](https://github.com/mvdan/interfacer) <span> ★ 470, pushed 9 days ago </span> - A linter that suggests interface types.
-   [validate](https://github.com/mccoyst/validate) <span> ★ 58, pushed 25 days ago </span> - Automatically validates struct fields with tags.

Editor Plugins
--------------

-   [go-lang-idea-plugin](https://github.com/go-lang-plugin-org/go-lang-idea-plugin) <span> ★ 3268, pushed 0 days ago </span> Go plugin for IntelliJ IDEA.
-   [go-plus](https://github.com/joefitzgerald/go-plus) <span> ★ 846, pushed 2 days ago </span> - Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting
-   [Goclipse](https://github.com/GoClipse/goclipse) <span> ★ 521, pushed 2 days ago </span> - An Eclipse plugin for Go.
-   [gocode](https://github.com/nsf/gocode) <span> ★ 3048, pushed 37 days ago </span> - An autocompletion daemon for the Go programming language.
-   [GoSublime](https://github.com/DisposaBoy/GoSublime) <span> ★ 2196, pushed 0 days ago </span> - A Golang plugin collection for the text editor SublimeText 2 providing code completion and other IDE-like features.
-   [velour](https://github.com/velour/velour) <span> ★ 13, pushed 50 days ago </span> - An IRC client for the acme editor.
-   [vim-compiler-go](https://github.com/rjohnsondev/vim-compiler-go) <span> ★ 65, pushed 654 days ago </span> - A Vim plugin to highlight syntax errors on save.
-   [vim-go](https://github.com/fatih/vim-go) <span> ★ 4643, pushed 1 days ago </span> - Go development plugin for Vim.
-   [Watch](https://github.com/eaburns/Watch) <span> ★ 104, pushed 167 days ago </span> - Runs a command in an acme win on file changes.

Go Tools
--------

-   [colorgo](https://github.com/songgao/colorgo) <span> ★ 63, pushed 298 days ago </span> - A wrapper around `    go   ` command for colorized `    go build   ` output.
-   [gb](https://getgb.io/) - An easy to use project based build tool for the Go programming language.
-   [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) <span> ★ 29, pushed 141 days ago </span> - Bash completion for go and wgo.
-   [rts](https://github.com/galeone/rts) <span> ★ 97, pushed 3 days ago </span> - RTS: response to struct. Generates Go structs from server responses.
...
-   [aptly](https://github.com/smira/aptly) <span> ★ 1041, pushed 1 days ago </span> - aptly is a Debian repository management tool.
-   [awsenv](https://github.com/soniah/awsenv) <span> ★ 7, pushed 147 days ago </span> - a small binary that loads Amazon (AWS) environment variables for a profile.
-   [Banshee](https://github.com/eleme/banshee) <span> ★ 216, pushed 0 days ago </span> - Anomalies detection system for periodic metrics.
-   [Boom](https://github.com/rakyll/boom) <span> ★ 4174, pushed 0 days ago </span> - Boom is a tiny program that sends some load to a web application.
-   [bosun](https://github.com/bosun-monitor/bosun) <span> ★ 1764, pushed 0 days ago </span> - Time Series Alerting Framework.
-   [dogo](https://github.com/liudng/dogo) <span> ★ 90, pushed 211 days ago </span> - Monitoring changes in the source file and automatically compile and run (restart).
-   [Dropship](https://github.com/chrismckenzie/dropship) <span> ★ 22, pushed 4 days ago </span> - A tool for deploying code via cdn.
-   [EasySSH](https://github.com/hypersleep/easyssh) <span> ★ 93, pushed 181 days ago </span> - Golang package for easy remote execution through SSH and SCP downloading.
-   [Go Metrics](https://github.com/rcrowley/go-metrics) <span> ★ 1165, pushed 0 days ago </span> - Go port of Coda Hale's Metrics library: https://github.com/codahale/metrics.
-   [go-selfupdate](https://github.com/sanbornm/go-selfupdate) <span> ★ 361, pushed 188 days ago </span> - Enable your Go applications to self update.
-   [gobrew](https://github.com/cryptojuice/gobrew) <span> ★ 151, pushed 170 days ago </span> - gobrew lets you easily switch between multiple versions of go.
-   [godbg](https://github.com/sirnewton01/godbg) <span> ★ 185, pushed 83 days ago </span> - Web-based gdb front-end application.
-   [Gogs](https://gogs.io/) - A Self Hosted Git Service in the Go Programming Language.
-   [gonative](https://github.com/inconshreveable/gonative) <span> ★ 231, pushed 109 days ago </span> - Tool which creates a build of Go that can cross compile to all platforms while still using the Cgo-enabled versions of the stdlib packages.
-   [gox](https://github.com/mitchellh/gox) <span> ★ 1538, pushed 23 days ago </span> - A dead simple, no frills Go cross compile tool.
-   [goxc](https://github.com/laher/goxc) <span> ★ 1268, pushed 23 days ago </span> - build tool for Go, with a focus on cross-compiling and packaging.
-   [GVM](https://github.com/moovweb/gvm) <span> ★ 1959, pushed 16 days ago </span> - GVM provides an interface to manage Go versions.
-   [hk](https://github.com/heroku/hk) <span> ★ 766, pushed 56 days ago </span> - Heroku command-line interface in Go.
-   [kala](https://github.com/ajvb/kala) <span> ★ 793, pushed 15 days ago </span> - Simplistic, modern, and performant job scheduler.
-   [kubernetes](https://github.com/kubernetes/kubernetes) <span> ★ 14005, pushed 0 days ago </span> - Container Cluster Manager from Google.
-   [Mora](https://github.com/emicklei/mora) <span> ★ 147, pushed 86 days ago </span> - REST server for accessing MongoDB documents and meta data.
...
-   [Packer](https://github.com/mitchellh/packer) <span> ★ 5240, pushed 0 days ago </span> - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
-   [Rodent](https://github.com/alouche/rodent) <span> ★ 30, pushed 354 days ago </span> - Rodent helps you manage Go versions, projects and track dependencies.
-   [s3gof3r](https://github.com/rlmcpherson/s3gof3r) <span> ★ 662, pushed 72 days ago </span> - A small utility/library optimized for high speed transfer of large objects into and out of Amazon S3.
-   [Scaleway-cli](https://github.com/scaleway/scaleway-cli) <span> ★ 123, pushed 2 days ago </span> - Manage BareMetal Servers from Command Line (as easily as with Docker).
-   [Vegeta](https://github.com/tsenart/vegeta) <span> ★ 3727, pushed 2 days ago </span> - HTTP load testing tool and library. It's over 9000!
-   [webhook](https://github.com/adnanh/webhook) <span> ★ 381, pushed 8 days ago </span> - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
-   [Wide](https://wide.b3log.org/login) - A Web-based IDE for Teams using Golang.

### Other Software

-   [boxed](https://github.com/tejo/boxed) <span> ★ 46, pushed 350 days ago </span> - Dropbox based blog engine
-   [Cherry](https://github.com/rafael-santiago/cherry) <span> ★ 86, pushed 13 days ago </span> - A tiny webchat server in Go.
-   [Circuit](https://github.com/gocircuit/circuit) <span> ★ 1271, pushed 213 days ago </span> - Circuit is a programmable platform-as-a-service (PaaS) and/or Infrastructure-as-a-Service (IaaS), for management, discovery, synchronization and orchestration of services and hosts comprising cloud applications.
-   [Comcast](https://github.com/tylertreat/Comcast) <span> ★ 4206, pushed 37 days ago </span> - Simulate bad network connections.
-   [confd](https://github.com/kelseyhightower/confd) <span> ★ 2585, pushed 1 days ago </span> - Manage local application configuration files using templates and data from etcd or consul.
-   [Docker](http://www.docker.com/) - An open platform for distributed applications for developers and sysadmins.
-   [fleet](https://github.com/coreos/fleet) <span> ★ 2161, pushed 0 days ago </span> - A Distributed init System.
...
-   [gocc](https://github.com/goccmack/gocc) <span> ★ 34, pushed 8 days ago </span> - Gocc is a compiler kit for Go written in Go.
...
-   [Gor](https://github.com/buger/gor) <span> ★ 5014, pushed 0 days ago </span> - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
-   [heka](https://github.com/mozilla-services/heka) <span> ★ 3026, pushed 1 days ago </span> - universal tool for data processing from Mozilla. Large collection of built-in plugins. Extendable via Go and Lua plugin API.
...
-   [ipe](https://github.com/dimiro1/ipe) <span> ★ 149, pushed 31 days ago </span> - An open source Pusher server implementation compatible with Pusher client libraries written in GO.
-   [Juju](https://jujucharms.com/) - Cloud-agnostic service deployment and orchestration - supports EC2, Azure, Openstack, MAAS and more.
-   [limetext](http://limetext.org/) Lime Text is a powerful and elegant text editor primarily developed in Go that aims to be a Free and open-source software successor to Sublime Text.
-   [LiteIDE](https://github.com/visualfc/liteide) <span> ★ 2770, pushed 2 days ago </span> LiteIDE is a simple, open source, cross-platform Go IDE.
-   [mockingjay](https://github.com/quii/mockingjay-server) <span> ★ 234, pushed 11 days ago </span> Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests.
-   [naclpipe](https://github.com/unix4fun/naclpipe) <span> ★ 5, pushed 129 days ago </span> - A simple NaCL EC25519 based crypto pipe tool written in Go.
-   [nes](https://github.com/fogleman/nes) <span> ★ 2250, pushed 161 days ago </span> - A Nintendo Entertainment System (NES) emulator written in Go.
-   [orange-cat](https://github.com/noraesae/orange-cat) <span> ★ 140, pushed 223 days ago </span> - A Markdown previewer written in Go.
-   [peg](https://github.com/pointlander/peg) <span> ★ 284, pushed 36 days ago </span> - Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator.
-   [Postman](https://github.com/zachlatta/postman) <span> ★ 634, pushed 178 days ago </span> - Command-line utility for batch-sending email.
-   [restic](https://github.com/restic/restic) <span> ★ 591, pushed 4 days ago </span> - De-duplicating backup program.
-   [rkt](https://github.com/coreos/rkt) <span> ★ 5418, pushed 0 days ago </span> - An App Container runtime that integrates with init systems, is compatible with other container formats like Docker, and supports alternative execution engines like KVM.
-   [Seaweed File System](https://github.com/chrislusf/seaweedfs) <span> ★ 2392, pushed 5 days ago </span> - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
-   [shell2http](https://github.com/msoap/shell2http) <span> ★ 42, pushed 7 days ago </span> - Executing shell commands via http server (for prototyping or remote control).
-   [snap](https://github.com/intelsdi-x/snap) <span> ★ 663, pushed 0 days ago </span> - A powerful telemetry framework.
-   [Stack Up](https://github.com/pressly/sup) <span> ★ 916, pushed 8 days ago </span> - Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers.
-   [syncthing](https://syncthing.net/) - An open, decentralized file synchronization tool and protocol.
-   [Tenyks](https://github.com/kyleterry/tenyks) <span> ★ 153, pushed 19 days ago </span> - Service oriented IRC bot using Redis and JSON for messaging.
-   [toto](https://github.com/blogcin/ToTo) <span> ★ 5, pushed 43 days ago </span> - A simple proxy server written in Go language, can be used together with browser.
-   [toxiproxy](https://github.com/shopify/toxiproxy) <span> ★ 1224, pushed 24 days ago </span> - Proxy to simulate network and system conditions for automated tests.
...
-   [wellington](https://github.com/wellington/wellington) <span> ★ 180, pushed 15 days ago </span> - Sass project management tool, extends the language with sprite functions (like Compass).
...
-   [autobench](https://github.com/davecheney/autobench) <span> ★ 84, pushed 634 days ago </span> - Framework to compare the performance between different Go versions.
-   [go-benchmarks](https://github.com/tylertreat/go-benchmarks) <span> ★ 24, pushed 57 days ago </span> - A few miscellaneous Go microbenchmarks. Compare some language features to alternative aproaches.
-   [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) <span> ★ 696, pushed 9 days ago </span> - Go HTTP request router benchmark and comparison.
-   [go-type-assertion-benchmark](https://github.com/hgfischer/go-type-assertion-benchmark) <span> ★ 3, pushed 542 days ago </span> - Naive performance test of two ways to do type assertion in Go.
...
-   [gocostmodel](https://github.com/PuerkitoBio/gocostmodel) <span> ★ 47, pushed 474 days ago </span> - Benchmarks of common basic operations for the Go language.
-   [golang-micro-benchmarks](https://github.com/amscanne/golang-micro-benchmarks) <span> ★ 5, pushed 126 days ago </span> - Tiny collection of Go micro benchmarks. The intent is to compare some language features to others.
-   [golang-sql-benchmark](https://github.com/tyler-smith/golang-sql-benchmark) <span> ★ 21, pushed 406 days ago </span> - A collection of benchmarks for popular Go database/SQL utilities.
-   [gospeed](https://github.com/feyeleanor/GoSpeed) <span> ★ 49, pushed 86 days ago </span> - Go micro-benchmarks for calculating the speed of language constructs.
-   [kvbench](https://github.com/jimrobinson/kvbench) <span> ★ 11, pushed 733 days ago </span> - Key/Value database benchmark.
-   [skynet](https://github.com/atemerev/skynet) <span> ★ 576, pushed 6 days ago </span> - Skynet 1M threads microbenchmark.
-   [speedtest-resize](https://github.com/fawick/speedtest-resize) <span> ★ 69, pushed 223 days ago </span> - Compare various Image resize algorithms for the Go language.
...
-   [GoBooks](https://github.com/dariubs/GoBooks) <span> ★ 2075, pushed 28 days ago </span> - A curated list of Go books
...
-   [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) <span> ★ 5370, pushed 0 days ago </span> - A curated list of awesome remote jobs. A lot of them is looking for Go hackers.
-   [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) <span> ★ 16034, pushed 2 days ago </span> - List of other amazingly awesome lists.
-   [Flipboard - Go Magazine](https://flipboard.com/section/the-golang-magazine-bVP7nS) - A collection of Go articles and tutorials.
-   [Go Blog](http://blog.golang.org) - The official Go blog.
-   [Go Forum](https://forum.golangbridge.org) - Forum to discuss Go.
-   [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
-   [godoc.org](https://godoc.org/) - Documentation for open source Go packages.
-   [golang-graphics](https://github.com/mholt/golang-graphics) <span> ★ 76, pushed 242 days ago </span> - A collection of Go images, graphics, and art.
...
-   [Working with Go](https://github.com/mkaz/working-with-go) <span> ★ 501, pushed 197 days ago </span> - An intro to go for experienced programmers.

Windows
-------

-   [go-ole](https://github.com/go-ole/go-ole) <span> ★ 189, pushed 42 days ago </span> - Win32 OLE implementation for golang.
