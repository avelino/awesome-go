...
* [gnNxI](https://github.com/google/gnxi) - A collection of tools for Network Management that use the gNMI and gNOI protocols.
* [gNMI](https://github.com/openconfig/gnmi) - This repository contains reference Go implementations for gNMI.
