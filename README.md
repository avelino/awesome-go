...
- [genie](https://github.com/stackgenhq/genie) - agentic platform using ReAcTree reasoning engine to plan and execute complex enterprise tasks with HITL governance.
