...
- [Breeze](https://github.com/nelthaarion/breeze) -Breeze, A ridiculously fast, event-driven Go web framework built for maximum throughput, minimal allocations, native WebSockets, Swagger, Dashboard, Middlewares, and production-ready APIs.
