...
- [SQLike](https://github.com/si3nloong/sqlike) - Yet another MySQL's ORM which only support latest feature support such as `Enum`, `generated column`, `Set`, `Json` and `Spatial` etc.
...
- Utility
  ...
  - [Tagify](https://github.com/zoomio/tagify) - Produces a set of tags from given source. \* [textwrap](https://github.com/isbm/textwrap) - Implementation of `textwrap` module from Python.
