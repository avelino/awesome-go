...
- [SafeDep-vet](https://github.com/safedep/vet) - A tool for protecting against open source software supply chain attacks through policy-as-code enforcement, vulnerability scanning, and malicious package detection.
