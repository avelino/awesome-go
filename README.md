...
- [Genkit Go](https://genkit.dev/docs/go/get-started/) - Framework created by Google for building, deploying, and monitoring AI-powered agentic applications in Go.
