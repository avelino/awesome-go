...
* [dog-tunnel](https://github.com/vzex/dog-tunnel) - P2p tunnel for port-forward(tcp or udp), socks5 proxy or transparent proxy. Support smart-mode(auto-decide how to proxy without blacklist or whitelist)
