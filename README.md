...
* Testing Frameworks
    ...
    * [go-testpredicate](https://github.com/maargenton/go-testpredicate) - Test assertions library using predicate-like syntax, producing extensive diagnostics output.
