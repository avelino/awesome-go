...
- [Gandalf](https://github.com/Feedback-Frog/gandalf) - Ultra-fast, persistent, and highly concurrent rate limiting functionality for Go. Features local file-based, per-key customizable limits, millisecond to monthly precision, advanced retry logic, and easy integration with Gin or any HTTP mux.
