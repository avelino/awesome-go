...
- [Genkit Go](https://github.com/firebase/genkit/tree/main/go) - Framework from Google for building, deploying, and monitoring AI-powered agentic applications in Go.
