...
- [graviton](https://github.com/deroproject/graviton) - ZFS for key-value stores. Graviton Database is simple, fast, versioned, authenticated, embeddable key-value store database in pure GOLANG.
