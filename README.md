...
* [id3v2](https://github.com/bogem/id3v2) - Fast and stable ID3 writing library for Go
...
* [Socker](https://github.com/cosiner/socker) - A library for Go to simplify the use of SSH, support keepalive and multiplexing.
