...
- [golang-rest-api-template](https://github.com/MitulShah1/golang-rest-api-template) - Ready to use Golang template for REST API with MySQL database, basic authentication, logging and cache.
