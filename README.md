...
- [uuidv8](https://github.com/ash3in/uuidv8) - A first-of-its-kind Go UUIDv8 library for generating, parsing, serializing and validating UUIDv8 based on the latest UUIDv8() specification.
