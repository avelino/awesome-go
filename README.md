...
* [go-logging](https://github.com/op/go-logging) - Package logging implements a logging infrastructure; customizable and supports different logging backends like syslog, file and memory.
