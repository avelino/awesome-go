...
- [argon2password](https://github.com/hlpmenu/argon2password) - Password hashing & comparision following OWASP recommendations 2025 +  Password generation, validation etc
