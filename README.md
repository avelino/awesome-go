...
- [orpheus](https://github.com/agilira/orpheus) - High-performance CLI framework designed to be ~30× faster than popular alternatives, with security hardening, plugin storage, and production observability.
