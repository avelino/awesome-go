...
* [go-exiftool](https://github.com/barasher/go-exiftool) - Go bindings for ExifTool, the well-known library used to extract as much medatata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...).
