...
* Relational Databases
    ...
    * [go-sqlite-lite](https://github.com/bvinc/go-sqlite-lite) - is a SQLite driver for Go without database/sql
    ...
    * [sqlite](https://pkg.go.dev/modernc.org/sqlite) - Package sqlite is a CGo-free port of SQLite with database/sql .
