...
* [Tekton Pipelines](https://github.com/tektoncd/pipeline) - The Tekton Pipelines project provides k8s-style resources for declaring CI/CD-style pipelines.
...
* [Golang Warsaw](https://www.meetup.com/Golang-Warsaw/)
