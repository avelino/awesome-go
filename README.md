...
* Specific Formats
    ...
    * [pagser](https://github.com/foolin/pagser) - Pagser is a simply, extensible, configurable parse and deserialize html page to struct based on goquery and struct tags for golang crawler.
