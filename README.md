...
- [<img align="right" src="https://github.com/avelino/awesome-go/raw/master/tmpl/assets/logo.png" alt="awesome-go" title="awesome-go" /> Awesome Go](#img-alignright-srchttpsgithubcomavelinoawesome-gorawmastertmplassetslogopng-altawesome-go-titleawesome-go--awesome-go)
...
* [PingMe](https://github.com/kha7iq/pingme) - PingMe is a CLI tool which provides ability to send messages or alerts to multiple messaging platforms.
