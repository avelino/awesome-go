...
- [mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go) - Local-first smart proxy for the Model Context Protocol with BM25 tool discovery, security quarantine, and Docker isolation.
