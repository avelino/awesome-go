...
- [dependi](https://marketplace.visualstudio.com/items?itemName=fill-labs.dependi) - A dependency management extension for Visual Studio Code supporting Go language
