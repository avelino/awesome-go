...
* [MMOA](https://github.com/claygod/mmoa) - MMOA microframework is to create a monolithic message-based applications that support the easy selection of any service from the monolith.
