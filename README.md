...
- [ai-gateway](https://github.com/ferro-labs/ai-gateway) - High-performance AI gateway for routing LLM requests across 29 providers via an OpenAI-compatible API.
