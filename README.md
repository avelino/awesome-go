...
- [GoNB](https://github.com/janpfeifer/gonb) - Interactive Go programming with Jupyter Notebooks with code completion and inspection, using on-the-fly compilation.
